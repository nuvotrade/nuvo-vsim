/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc` (hash: 0d11e43e43d138319c64f8c1a22d5b2b)
...
interface __BaseEnv_Env {
	...
	NUVO_ENVIRONMENT: "shadow";
	NUVO_AUTHORITY_LEVEL: "2";
	NUVO_BROKER_MODE: "READ_ONLY";
	NUVO_BROKER_EXECUTION_MODE: "SHADOW_ONLY";
	NUVO_ALLOWED_STRUCTURES: "CSP,SHARES,COVERED_CALL";
	NUVO_SYMBOLS: "SPY,QQQ,IWM";
	NUVO_FUND_SYMBOLS: "SPY,QQQ,IWM";
	NUVO_DTE_TARGETS: "14,30,45";
	NUVO_CC_DTE_TARGETS: "7,14,21";
	NUVO_MAX_CHAIN_AGE_MS: "120000";
	NUVO_MAX_QUOTE_AGE_MS: "60000";
	NUVO_MARKET_SOURCE: "SCHWAB_MARKET_DATA";
	NUVO_UNDERLYING_SOURCE: "SCHWAB_MARKET_DATA";
	NUVO_SCHWAB_VIX_SYMBOL: "$VIX";
	NUVO_SCREEN_SAMPLES: "1500";
	NUVO_DECISION_SAMPLES: "8000";
	NUVO_REFINE_TOP: "8";
	NUVO_AI_MODEL: "@cf/openai/gpt-oss-120b";
	TELEGRAM_BOT_USERNAME: "nuvovsim_bot";
	PUBLIC_ORIGIN: "https://nuvo-vsim-v5-shadow.yulgutierrez.workers.dev";
	SCHWAB_CALLBACK_URL: "https://nuvo-vsim-v5-shadow.yulgutierrez.workers.dev/api/integrations/schwab/callback";
	ACCESS_TEAM_DOMAIN: "yulgutierrez";
	ACCESS_AUD: "9ff9966020d5438ee91a675d8ab2edc27860f1778c85c5f7f6503fd3ef00b679";
	MCP_ACCESS_AUD: "dc81ee7c6b88272159b7c985deaea3ecd8712b0a21f518cddbb585d6e1950b35";
	ACCOUNT_COORDINATOR: DurableObjectNamespace<import("./cloudflare/entry").VsimAccountCoordinator>;
	MARKET: Fetcher /* master */;
	SHADOW_CYCLE_WORKFLOW: Workflow<Parameters<import("./cloudflare/entry").ShadowCycleWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare/entry");
		durableNamespaces: "VsimAccountCoordinator";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NUVO_ENVIRONMENT" | "NUVO_AUTHORITY_LEVEL" | "NUVO_BROKER_MODE" | "NUVO_BROKER_EXECUTION_MODE" | "NUVO_ALLOWED_STRUCTURES" | "NUVO_SYMBOLS" | "NUVO_FUND_SYMBOLS" | "NUVO_DTE_TARGETS" | "NUVO_CC_DTE_TARGETS" | "NUVO_MAX_CHAIN_AGE_MS" | "NUVO_MAX_QUOTE_AGE_MS" | "NUVO_MARKET_SOURCE" | "NUVO_UNDERLYING_SOURCE" | "NUVO_SCHWAB_VIX_SYMBOL" | "NUVO_SCREEN_SAMPLES" | "NUVO_DECISION_SAMPLES" | "NUVO_REFINE_TOP" | "NUVO_AI_MODEL" | "TELEGRAM_BOT_USERNAME" | "PUBLIC_ORIGIN" | "SCHWAB_CALLBACK_URL" | "ACCESS_TEAM_DOMAIN" | "ACCESS_AUD" | "MCP_ACCESS_AUD">> {}
}
