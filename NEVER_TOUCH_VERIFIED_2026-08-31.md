...
| Worker `nuvo-vsim-v5-shadow` | Present and deployed; 49 bindings; Worker version `6ef9d0dd-a7e9-4f91-88cf-337228f01fa8`; bundle downloaded and hashed in Wave 0. | **NEVER TOUCH. VERIFIED.** |
...
| Cron `*/5 * * * *` | Attached to the live Worker. | **NEVER TOUCH. VERIFIED.** The mandate says to keep and fix its self-probe separately. |
